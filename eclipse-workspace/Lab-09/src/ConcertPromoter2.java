...
public class ConcertPromoter2 {
	...
	public static void main(String[] args) {
		...
		while(input.equalsIgnoreCase("quit")!= true)
		{
			...
			System.out.println("Has sold "+concert.getNumTicketsSoldByPhone()+" tickets by phone");
			System.out.println("Has sold "+concert.getNumTicketsSoldAtVenue()+" tickets at the venue");
			...
			case 3:
				...
				concert.setPriceAtVenue(key.nextDouble());
				break;
			case 4:
